...
import type { Op } from "../../src/delta/interface";
import { MutateDelta } from "../../src/mutate/delta";
...
describe("immutable delta", () => {
  ...
  it("each line", () => {
    let i = 0;
    const delta = new MutateDelta([text1, eol1, text2, eol2]);
    const spy = jest.fn();
  ...
  it("push", () => {
    const delta = new MutateDelta([text1]);
