...
module.exports = {
  ...
  resolve: {
    alias: {
      ...
      "blocks-kit-core": path.resolve(__dirname, "../core/src"),
      "blocks-kit-delta": path.resolve(__dirname, "../delta/src"),
      "blocks-kit-shared": path.resolve(__dirname, "../shared/src"),
      "blocks-kit-plugin": path.resolve(__dirname, "../plugin/src"),
      "blocks-kit-utils": path.resolve(__dirname, "../utils/src"),
    },
  },
  builtins: {
    define: {
